...
const EmailVerification = () => {
  ...
  return (
    <div 
     ...
     relative overflow-hidden bg-mercedes'
    >
      <div
      ...
      >
        <motion.div
          ...
          className='bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur
          rounded-2xl shadow-2xl p-8 w-full max-w-md'
        >
          <h2 
            className='text-3xl font-bold mb-6 text-center bg-gradient-to-t from-green-400 to-emerald-500
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <motion.button
              ...
              className='w-full bg-gradient-to-r from-blue-500 to-emerald-600
              text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-blue-600
