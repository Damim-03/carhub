...
export const manufacturers = [
  ...
  export const Products = [
    { index: 1 ,title: 'Mercedes', value: 'Mercedes-Benz', image: './Mercedes-Benz.png' , link:'/Mercedes'},
    { index: 2 ,title: 'BMW', value: 'BMW', image: './BWM.png' },
    { index: 3 ,title: 'Audi', value: 'Audi', image: './Audi.png' },
      { index: 4 ,title: 'Volkswagen', value: 'Volkswagen', image: './volkswagen.png' },
    { index: 5 ,title: 'Toyota', value: 'Toyota', image: './toyota.png' },
    { index: 6 ,title: 'Tesla', value: 'Tesla', image: './tesla.png' },
    { index: 7 ,title: 'Porsche', value: 'Porsche', image: './porsche.png' },
      { index: 8 ,title: 'Ferrari', value: 'Ferrari', image: './ferrari.png' },
    { index: 9 ,title: 'Lamborghini', value: 'Lamborghini', image: './lamborghini.png' },
      { index: 10 ,title: 'Rolls Royce', value: 'Rolls-Royce', image: './rolls royce.png' },
    { index: 11 ,title: 'Fiat', value: 'Fiat', image: './fiat.png' },
    { index: 12 ,title: 'Nissan', value: 'Nissan', image: './nissan.png' },
  ]
