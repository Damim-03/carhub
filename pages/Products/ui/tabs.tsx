...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ...
        className={cn(
            ...
            "bg-muted p-1 text-muted-foreground space-x-6", // Added space-x-6 for spacing
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ref={ref}
        className={cn(
            "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium mx-2",
