...
const ProductDetailsComponent = ({ product, className }: ProductDetailsProps) => {
    return (
        <div className={cn("bg-white dark:bg-slate-800 rounded-md shadow-sm p-6", className)}>
            <Tabs defaultValue="description">
                <TabsList className="grid w-full bg-white grid-cols-3 gap-x-6 px-4">
                    <TabsTrigger value="description" className={'text-black dark:text-black'}>Description</TabsTrigger>
                    <TabsTrigger value="specifications" className={'text-black dark:text-black'}>Specifications</TabsTrigger>
                    <TabsTrigger value="reviews" className={'text-black dark:text-black'}>Reviews ({product.reviewCount})</TabsTrigger>
                </TabsList>
