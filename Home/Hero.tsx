  ...
  return (
      <div className="hero">
        ...
        <div className="flex-1 pt-36 px-4 sm:px-6 lg:px-8">
          <h1 id="hero" className="hero__title opacity-0 dark:text-white text-center sm:text-left">
        ...
        <div className="hero__image-container">
          <div id="hero_png" className="hero__image opacity-0 transition-opacity duration-1000">
            <Image
                src={"./hero.png"}
                alt="hero"
                fill
